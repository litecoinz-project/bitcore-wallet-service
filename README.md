...
See [Bitcore-wallet-client](https://github.com/joebl4ck/bitcore-wallet-client-ltz) for the *official* client library that communicates to BWS and verifies its response. Also check [Bitcore-wallet](https://github.com/bitpay/bitcore-wallet) for a simple CLI wallet implementation that relies on BWS.
...
See [Bitcore Wallet Client](https://github.com/joebl4ck/bitcore-wallet-client-ltz/blob/master/lib/api.js#L73) for implementation details.
