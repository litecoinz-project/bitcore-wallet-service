 ...
 * @param {string} opts.coin[='ltz'] - The coin for this wallet (btc).
 ...
 * @param {string} opts.coin[='ltz'] - The expected coin for this wallet (btc).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['ltz', 'bit'], value.toLowerCase());
    },
  }];
